...
# ── FECHA DE PRUEBA: cambia esta línea para simular otra fecha ──────────────
# Para producción: FECHA_SIMULADA = None
# Para prueba:     FECHA_SIMULADA = datetime(2026, 2, 1)  o  datetime(2026, 2, 2)
FECHA_SIMULADA = datetime(2026, 2, 1)

hoy = FECHA_SIMULADA if FECHA_SIMULADA else datetime.now()
...
if __name__ == "__main__":
    ...
    if todos_ok:
        print("\nTodos los ficheros descargados y listos. Puedes ejecutar unificar.py.")
    else:
